...
print(parse_topic_data(["[GB] GMK Red & Blue Samurai (GB Closed)"]))
print(parse_topic_data(["[GB] GMK Lunar 🚀 — All Kits Will Be Made; Final Numbers Posted"]))
print(parse_topic_data(["[GB]Enjoypbt KON MOMO (7.10~7.30)"]))
