...
clean_board_data(infilepath="data/210121gb_raw.csv", outfilepath="data/210121gb_clean.csv")
clean_board_data(infilepath="data/210121ic_raw.csv", outfilepath="data/210121ic_clean.csv")
